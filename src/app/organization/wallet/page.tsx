  ...
  return (
    <div className="p-6 space-y-8 animate-fade-in max-w-xl">
      ...
      <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
        ...
        <p className="text-xs text-gray-500 mt-2">Used to fund escrow on deal creation.</p>
      </div>
      ...
      <section>
        ...
        <form onSubmit={handleDeposit} className="space-y-3">
          <FormInput label="Transaction Hash" value={txHash} onChange={setTxHash} placeholder="0x…" required />
          <FormInput label="Amount (USDC)" type="number" value={amount} onChange={setAmount} placeholder="500" required />
          <button
            type="submit"
            disabled={processing}
